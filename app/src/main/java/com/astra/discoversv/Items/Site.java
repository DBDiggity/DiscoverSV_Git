...
public class Site {
    ...
    public List<Site> initSites(){
        ...
        array.add(new Site("Falls of Belaine"
                ,"Georgetown"
                , "The Falls of Belaine is among St. Vincent's finest natural wonders. The sparkling waters plunge about 60ft into a rock-enclosed fresh water pool, perfect for swimming. "
                , EntertainmentTypes.FALLS
